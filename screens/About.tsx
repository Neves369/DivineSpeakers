      ...
      <Layout style={styles.container}>
        <Card>
          <Text>
            ...
            objetivo é edificar sua vida e dessa forma glorificar a Jesus
            Cristo, lembrando-nos da história da igreja e trazendo visibilidade
            a uma teologia saudável e pura.
            {"\n\n\n"}
          </Text>
          <Text>
